 ...
 */
abstract class EnumClass implements \JsonSerializable, EnumInterface
{
    /**
     * Enum value
     *
     ...
     *
     * @return array<string, array<array-key, string>> Constant name in key, constant value in value
     */
